...
/* harmony import */ var _modules_expandable_expandable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/expandable/expandable */ "./js/modules/expandable/expandable.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordions"])();
    Object(_modules_expandable_expandable__WEBPACK_IMPORTED_MODULE_4__["initExpandable"])();
...
function initAccordions() {
  ...
  function toggleItemState(_ref) {
    var target = _ref.target;
    var container = target.closest('[data-accordion]');
    var items = container.querySelectorAll('[data-accordion-item]');
    var currentItem = target.closest('[data-accordion-item]');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initExpandable", function() { return initExpandable; });
function initExpandable() {
  var buttons = document.querySelectorAll('[data-expandable-button]');
  buttons.forEach(function (button) {
    button.addEventListener('click', function (_ref) {
      var target = _ref.target;
      var container = target.closest('[data-expandable]');
      if (container) {
